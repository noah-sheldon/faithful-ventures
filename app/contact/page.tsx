      ...
      <section className="w-full bg-gradient-to-br from-blue-50 to-indigo-50 py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Ready to transform your digital presence? Get in touch to discuss your project and 
            receive a free consultation with our team of experts.
          </p>
              ...
              <div className="bg-white rounded-xl shadow-xl p-8 border">
                ...
                {state.succeeded ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Project Type */}
                    <div>
                      <label htmlFor="project-type" className="block text-sm font-semibold text-gray-900 mb-2">
                        Project Type *
                      </label>
                      <Select onValueChange={setProjectType} name="project-type" required>
                    ...
                    <div>
                      ...
                      <Select onValueChange={setBudget} name="budget" required>
                        <SelectTrigger className="border-gray-300">
                    ...
                    >
                      {state.submitting ? "Sending Request..." : "Get Free Consultation"}
                    </Button>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-white rounded-lg border">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@faithfulvc.xyz" className="text-blue-600 hover:text-blue-700">
                        info@faithfulvc.xyz
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-white rounded-lg border">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">London, UK (Remote & On-site)</div>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    {[
                      {
                        ...
                        description: "Our team analyzes your project requirements and timeline."
                      },
                      {
                        step: "2",
                        title: "Free Consultation Call",
                        description: "We schedule a 30-minute call to discuss your goals and answer questions."
                      },
                      {
                        step: "3",
                        title: "Custom Proposal",
                        description: "You receive a detailed proposal with timeline, pricing, and next steps."
                      }
                    ].map((item, idx) => (
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get quick answers to common questions about working with FaithfulVC.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "Project timelines vary based on scope and complexity. Simple websites take 2-4 weeks, while comprehensive digital transformations can take 3-6 months. We provide detailed timelines in our proposals."
              },
              {
                question: "Do you work with startups or only enterprises?",
                answer: "We work with businesses of all sizes, from startups to Fortune 500 companies. Our services are tailored to match your budget and growth stage."
              },
              {
                question: "What makes your security services different?",
                answer: "Unlike typical agencies, we have certified ethical hackers on our team who embed security best practices into every project from day one. We also offer comprehensive penetration testing and compliance consulting."
              },
              {
                question: "Do you provide ongoing support after project completion?",
                answer: "Yes, we offer various support packages including maintenance, monitoring, and continuous optimization. Many clients choose our ongoing partnerships for long-term success."
              },
              {
      ...
      <section className="w-full py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            >
              <a href="mailto:info@faithfulvc.xyz">
                Send Us an Email
              </a>
            </Button>
          </div>
